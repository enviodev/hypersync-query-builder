...
test("generateEnglishDescription - multiple block hashes", () => {
  ...
  assertEqual(
    result,
    "Match blocks where: the block hash is 0x1234567890abcdef OR 0xfedcba0987654321",
  )
})
...
test("generateEnglishDescription - single miner", () => {
  ...
  assertEqual(
    result,
    "Match blocks where: the miner address is 0xea674fdde714fd979de3edf0f56aa9716b898ec8",
  )
})
...
test("generateEnglishDescription - multiple miners", () => {
  ...
  assertEqual(
    result,
    "Match blocks where: the miner address is 0xea674fdde714fd979de3edf0f56aa9716b898ec8 OR 0x52bc44d5378309ee2abf1539bf71de1b7d7be3b5",
  )
})

test("generateEnglishDescription - hash and miner combined", () => {
  let state = {
    hash: Some(["0x1234567890abcdef"]),
    miner: Some(["0xea674fdde714fd979de3edf0f56aa9716b898ec8"]),
  }
  let result = generateEnglishDescription(state)
  assertEqual(
    result,
    "Match blocks where: the block hash is 0x1234567890abcdef AND the miner address is 0xea674fdde714fd979de3edf0f56aa9716b898ec8",
  )
})
...
test("generateEnglishDescription - multiple hashes and miners", () => {
  ...
  assertEqual(
    result,
    "Match blocks where: the block hash is 0x1234567890abcdef OR 0xfedcba0987654321 AND the miner address is 0xea674fdde714fd979de3edf0f56aa9716b898ec8 OR 0x52bc44d5378309ee2abf1539bf71de1b7d7be3b5",
  )
})
