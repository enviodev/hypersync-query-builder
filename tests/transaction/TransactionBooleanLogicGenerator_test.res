...
test("generateEnglishDescription - multiple sighashes", () => {
  ...
  assertEqual(
    result,
    "Match transactions where: the function signature is 0xa9059cbb OR 0x23b872dd",
  )
})
...
test("generateEnglishDescription - single contract address", () => {
  ...
  assertEqual(
    result,
    "Match transactions where: the contract address is 0xA0b86a33E6441c8C06DD2F1ea9D25E4A7BB9A74e",
  )
})
...
test("generateEnglishDescription - complex transaction filter", () => {
  ...
  assertEqual(
    result,
    "Match transactions where: the sender address is 0x1234 AND the recipient address is 0x5678 AND the function signature is 0xa9059cbb AND the transaction is successful",
  )
})
