  ...
  <div>
    ...
    <div className="min-h-80">
      ...
      | Logs => 
        <div>
          <div className="mb-4">
            <h4 className="text-lg font-medium text-gray-900 mb-2">{"Log Filters Boolean Logic"->React.string}</h4>
          ...
          {hasLogFilters 
            ...
            : <div className="text-center py-12">
                ...
                <h4 className="text-lg font-medium text-gray-500 mb-2">{"No Log Filters"->React.string}</h4>
                <p className="text-gray-400">{"Add log filters to see the boolean logic visualization"->React.string}</p>
              </div>
          }
        </div>
      ...
      | Transactions =>
        <div>
          <div className="mb-4">
            <h4 className="text-lg font-medium text-gray-900 mb-2">{"Transaction Filters Boolean Logic"->React.string}</h4>
            <p className="text-sm text-gray-600">
          ...
          {hasTransactionFilters 
            ...
            : <div className="text-center py-12">
                <div className="text-gray-400 mb-4">
                  <svg className="w-12 h-12 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M7 4V2a1 1 0 011-1h4a1 1 0 011 1v2h4a1 1 0 011 1v2a1 1 0 01-1 1h-1v9a2 2 0 01-2 2H8a2 2 0 01-2-2V8H5a1 1 0 01-1-1V5a1 1 0 011-1h4z" />
                  </svg>
                </div>
                <h4 className="text-lg font-medium text-gray-500 mb-2">{"No Transaction Filters"->React.string}</h4>
                <p className="text-gray-400">{"Add transaction filters to see the boolean logic visualization"->React.string}</p>
              </div>
          }
        </div>
      ...
      | Blocks =>
        <div>
          <div className="mb-4">
            <h4 className="text-lg font-medium text-gray-900 mb-2">{"Block Filters Boolean Logic"->React.string}</h4>
            <p className="text-sm text-gray-600">
          ...
          {hasBlockFilters 
            ...
            : <div className="text-center py-12">
                ...
                <h4 className="text-lg font-medium text-gray-500 mb-2">{"No Block Filters"->React.string}</h4>
                <p className="text-gray-400">{"Add block filters to see the boolean logic visualization"->React.string}</p>
              </div>
          }
        </div>
      }}
