          ...
          <div className="p-6 lg:p-4 lg:pr-2">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                ...
                // Advanced Options
                <AdvancedOptions
                  query={query} onQueryChange={newQuery => setQuery(_ => newQuery)}
                />
                      ...
                      <div className="grid gap-4">
                        ...
                        {Array.mapWithIndex(query.transactions->Option.getOr([]), (
                          ...
                          <TransactionFilter
                            ...
                            onToggleExpand={() =>
                              toggleFilter(`transaction-${Int.toString(index)}`)}
                          />
                        )->React.array}
                        ...
                        // Trace Filters
                        {selectedChainSupportsTraces()
                          ? Array.mapWithIndex(query.traces->Option.getOr([]), (
                              traceFilter,
                              index,
                            ) =>
                              <TraceFilter
