...
let make = (~query: QueryStructure.query, ~onQueryChange: QueryStructure.query => unit) => {
  ...
  <div className="mb-8 bg-white shadow rounded-lg">
    <div className="px-6 py-4 border-b border-gray-200">
      ...
      >
        <div>
          <h3 className="text-lg font-medium text-gray-900">{"Advanced Options"->React.string}</h3>
    ...
    {isExpanded ? (
      <div className="p-6 space-y-6">
        // Block Range
        <div>
          <h4 className="text-md font-medium text-gray-900 mb-3">{"Block Range"->React.string}</h4>
        ...
        // Join Mode
        <div>
          <h4 className="text-md font-medium text-gray-900 mb-3">{"Join Mode"->React.string}</h4>
        ...
        <div>
          <label className="flex items-center">
            ...
            />
            <span className="ml-2">
              <span className="text-sm font-medium text-gray-700">{"Include All Blocks"->React.string}</span>
        ...
        // Result Limits
        <div>
          <h4 className="text-md font-medium text-gray-900 mb-3">{"Result Limits"->React.string}</h4>
          <p className="text-sm text-gray-600 mb-3">
